...
- [FAQ and common issues](#faq-and-common-issues)
  ...
  - [Visual Studio Live Share has experimental support](#visual-studio-live-share-has-experimental-support)
  - [LaTeX Utilities is not supported](#latex-utilities-is-not-supported)
  - [The directory ~/node\_modules/ may cause errors](#the-directory-node_modules-may-cause-errors)
  ...
  - [LaTeX-Workshop shadows vscode's default keybindings](#latex-workshop-shadows-vscodes-default-keybindings)
    - [LaTeX-Workshop uses Ctrl+L as the first key of many keybindings](#latex-workshop-uses-ctrll-as-the-first-key-of-many-keybindings)
    - [LaTeX-Workshop uses Ctrl+M for fonts keybindings](#latex-workshop-uses-ctrlm-for-fonts-keybindings)
...
See [Viewing & Synctex](View#synctex).
